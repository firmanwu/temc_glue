...
-- 正在傾印表格  temc_glue.order 的資料：~8 rows (大約)
...
REPLACE INTO `order` (`orderID`, `customerOrderID`, `deadline`, `sales`, `product`, `customer`, `packaging`, `expectingPackageNumber`, `expectingWeight`, `remainingPackageNumber`, `remainingWeight`, `complete`) VALUES
	('E20180803001', '20180803001', '2018-08-14', '內銷', 5, 1, 1, 20, 340, 12, 204, 0),
	('E20180803002', '20180803002', '2018-08-17', '外銷', 2, 2, 2, 300, 7500, 220, 5500, 0),
	('E20180803003', '20180803003', '2018-08-13', '內銷', 3, 1, 1, 50, 850, 0, 0, 0),
	...
	('E20180803010', '20180803010', '2018-08-31', '內銷', 5, 1, 2, 33, 825, 19, 475, 0);
...
-- 正在傾印表格  temc_glue.production 的資料：~11 rows (大約)
...
REPLACE INTO `production` (`productionID`, `order`, `operator`, `batchNumber`, `producingDate`, `producedPackageNumber`, `producedWeight`) VALUES
	(2, 'E20180803005', 1, '20180803001', '2018-08-07', 15, 375),
	(3, 'E20180803008', 2, '20180803002', '2018-08-15', 8, 136),
	(4, 'E20180803002', 1, '20180803003', '2018-08-13', 80, 2000),
	(5, 'E20180803007', 2, '20180803004', '2018-08-16', 20, 500),
	(6, 'E20180803001', 1, '20180803005', '2018-08-09', 8, 136),
	(7, 'E20180803009', 2, '20180803006', '2018-08-20', 21, 525),
	(8, 'E20180803004', 1, '20180803007', '2018-08-16', 35, 595),
	(10, 'E20180803008', 2, '20180803008', '2018-08-27', 7, 119),
	(11, 'E20180803009', 1, '20180803009', '2018-08-23', 4, 100),
